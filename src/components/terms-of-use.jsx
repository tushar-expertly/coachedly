    ...
    <Layout>
      <div className="bg-blue-200 min-h-screen">
        <div className="max-w-4xl mx-auto px-4 py-8">
          ...
          <p className="mb-4">
            Materials on the Coachedly website may be subject to copyright
          ...
          <p className="mb-4">
            Information on this website is provided for convenience. Coachedly
            makes efforts to ensure accuracy but cannot guarantee the
            reliability of third-party information. Coachedly is not liable for
            actions taken based on this information or for any resulting
            consequences.
          </p>
          <p className="mb-4">External Links</p>
          <p className="mb-4">
            The Coachedly web portal may include links to external websites
            ...
            imply endorsement by Coachedly. Links may be removed or updated at
            any time without notice.ofess. Links may be removed or updated at
            any time without notice.
          </p>
          {/* <p className="font-semibold mb-2">External Links</p> */}
          <p className="mb-4">
            For concerns about linked external websites, please contact the
            respective organizations. Coachedly is not responsible for external
            site content.
          </p>
          {/* <p className="mb-4">
